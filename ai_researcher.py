...
from arxiv_tool import paper_search   # <- unified arXiv + IEEE search
...
config = {"configurable": {"thread_id": 111111}}

# Step4: Define initial prompt with IEEE included
INITIAL_PROMPT = """
...
# Step5: Helper to stream responses
